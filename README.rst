...
.. image:: https://travis-ci.org/calmjs/calmjs.dev.svg?branch=2.2.2
    :target: https://travis-ci.org/calmjs/calmjs.dev
.. image:: https://ci.appveyor.com/api/projects/status/0mxtiaf2j98w5fy6/branch/2.2.2?svg=true
    :target: https://ci.appveyor.com/project/metatoaster/calmjs-dev/branch/2.2.2
.. image:: https://coveralls.io/repos/github/calmjs/calmjs.dev/badge.svg?branch=2.2.2
    :target: https://coveralls.io/github/calmjs/calmjs.dev?branch=2.2.2
